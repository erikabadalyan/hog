...
def roll_dice(num_rolls, dice=six_sided):
    ...
    assert type(num_rolls) == int, 'num_rolls 1must be an integer.'
...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    player = abs(player_score % 10 -  player_score // 10 % 10)
    opponent = abs(opponent_score % 10 -  opponent_score // 10 % 10)
